...
A função reduce(), funciona da seguinte forma:
    ...
    Passo 2: res = f(res1, a3) # Aplica a função passando o resultado do psso1 mais o terceiro elemento e guarda o res.
...
funcao(funcao(funcao(funcao(funcao(a1, a2), a3), 4), ...), an)
"""

# Como funciona na prática?

# Vamos utilizar a função reduce() para multiplicar todos os npumeros de uma lista
